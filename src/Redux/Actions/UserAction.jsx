...
export const login = (email, password) => async(dispatch) => {
    try {
        ...
        const config = { headers: { 'Access-Control-Allow-Origin': '*', 'Content-Type': 'application/json' } };

        // let withCredentials = axios.defaults.withCredentials = true
...
export const loadUser = () => async (dispatch) => {
  try {
    ...
    let withCredentials = axios.defaults.withCredentials = true;
    const { data } = await axios.get('http://localhost:4000/api/user/profile', withCredentials);
